...
export function NotFoundPage() {
  return (
    <div className="min-h-screen bg-card flex items-center justify-center p-6 text-center">
      ...
      >
        <div className="w-16 h-16 rounded-2xl bg-surface-50 border border-surface-300 flex items-center justify-center text-primary-600 mb-6 shadow">
          <Home size={32} />
        </div>
        <h1 className="text-4xl font-bold font-display text-surface-900">404</h1>
        <h2 className="text-lg font-semibold text-surface-800 mt-2">Page Not Found</h2>
