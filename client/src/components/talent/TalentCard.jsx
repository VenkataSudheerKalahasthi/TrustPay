    ...
    <div className="p-5 rounded-2xl bg-surface-900 border border-surface-800 space-y-4 hover:border-surface-700 transition-all">
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-primary-500/10 text-primary-400 font-bold text-base flex items-center justify-center shrink-0">
          ...
          <div>
            ...
            <p className="text-3xs font-mono text-surface-400">{worker.title || 'Freelance Specialist'}</p>
          </div>
        </div>
      ...
      <p className="text-xs text-surface-300 line-clamp-2 leading-relaxed">{worker.bio || 'Experienced software engineer specializing in scalable applications and cloud architectures.'}</p>
