  ...
  return (
    <Card className="p-5 bg-surface-900 border-surface-800">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-lg font-bold text-primary-400">{progressPercentage}%</span>
      </div>

      {/* Progress Bar */}
      <div className="w-full bg-surface-800 h-2.5 rounded-full overflow-hidden mb-4">
        <div
      ...
      <div className="grid grid-cols-2 gap-3 text-xs">
        <div className="flex items-center gap-2 p-2.5 rounded-xl bg-surface-800/50 border border-surface-700/50">
          <CheckCircle2 size={16} className="text-emerald-400 shrink-0" />
          <div>
            <span className="text-surface-400 block text-2xs">Milestones Done</span>
        ...
        <div className="flex items-center gap-2 p-2.5 rounded-xl bg-surface-800/50 border border-surface-700/50">
          ...
          <div>
            <span className="text-surface-400 block text-2xs">Deliverables Approved</span>
            <span className="font-semibold text-surface-100">
