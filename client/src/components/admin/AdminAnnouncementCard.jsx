  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-lg space-y-2">
      <div className="flex items-center justify-between">
        <span className="text-xs font-mono font-bold text-sky-400 dark:text-primary-400 uppercase">Target: {announcement.targetRole || 'ALL'}</span>
      ...
      <h4 className="text-base font-bold text-white flex items-center gap-2">
        <Megaphone className="w-4 h-4 text-sky-400 dark:text-primary-400" />
        {announcement.title}
      </h4>
