...
export function NotFound() {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center text-center p-6">
      <div className="p-4 rounded-3xl bg-surface-800 border border-surface-700 text-primary-400 mb-6">
        <FileQuestion size={48} />
      </div>
      <h1 className="text-3xl font-bold font-display text-surface-50">404 – Page Not Found</h1>
