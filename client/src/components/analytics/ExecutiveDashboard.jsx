  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl space-y-6">
      <div className="flex items-center justify-between pb-4 border-b border-slate-800">
        <div>
          <span className="text-xs font-mono font-bold text-sky-400 dark:text-primary-400 uppercase tracking-widest">{dashboard.visibility} View</span>
        ...
        {onCustomize && (
          ...
          >
            <LayoutGrid className="w-4 h-4 text-sky-400 dark:text-primary-400" />
            Customize Layout
          </button>
        )}
      </div>
