...
export function Chip({
  ...
  const variantMap = {
    default: 'bg-surface-50 text-surface-800 border-surface-300 hover:bg-surface-700',
    primary: 'bg-primary-500/15 text-primary-700 border-primary-600/30 hover:bg-primary-500/25',
    secondary: 'bg-secondary-500/15 text-secondary-300 border-secondary-500/30 hover:bg-secondary-500/25',
    success: 'bg-success-500/15 text-success-300 border-success-200 hover:bg-success-500/25',
    warning: 'bg-warning-500/15 text-warning-300 border-warning-500/30 hover:bg-warning-500/25',
    danger: 'bg-danger-500/15 text-danger-300 border-danger-200 hover:bg-danger-500/25',
  };
