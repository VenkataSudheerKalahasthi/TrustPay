        ...
        <div className="relative flex items-center">
          ...
          >
            ...
            {options.map((opt) => {
              ...
              return (
                <option key={val} value={val} className="bg-surface-800 text-surface-50">
                  {lbl}
                </option>
              );
            })}
          </select>
          <ChevronDown size={16} className="absolute right-3.5 text-surface-400 pointer-events-none" />
        </div>
