    ...
    <div className="fixed inset-0 z-modal bg-card/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-card border border-surface-200 rounded-2xl w-full max-w-md p-6 shadow-2xl relative">
        <div className="flex items-center justify-between border-b border-surface-200 pb-4 mb-4">
          <h3 className="text-base font-semibold text-surface-900">Start New Conversation</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-surface-700 mb-1">Conversation Type</label>
            <select
              value={type}
          ...
          {type !== 'DIRECT' && (
            <div>
              <label className="block text-xs font-semibold text-surface-700 mb-1">Title</label>
              <input
                type="text"
                value={title}
          ...
          <div>
            <label className="block text-xs font-semibold text-surface-700 mb-1">Recipient User ID or Email *</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 rounded-xl bg-surface-50 border border-surface-300 text-xs text-surface-900 focus:outline-none focus:border-primary-600"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-semibold text-surface-700 mb-1">Project ID (Optional)</label>
              <input
                type="text"
                value={projectId}
            ...
            <div>
              <label className="block text-xs font-semibold text-surface-700 mb-1">Contract ID (Optional)</label>
              <input
                type="text"
                value={contractId}
